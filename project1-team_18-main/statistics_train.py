...
train_data = torchvision.datasets.EMNIST(root="./emnist_data",train=True,download=True,transform=None,split="byclass")
...
class statistics_train(QWidget):
    ...
    def init_UI(self):
        ...
        self.setWindowTitle('Statistics of train dataset')
